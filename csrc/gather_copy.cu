...
void gather_copy(
    ...
    int64_t batch_size, int64_t heads, int64_t cpu_v_length, int64_t gpu_v_length, int64_t map_size = 256)
{
...
void gather_copy_d2d_with_offsets(
    ...
    int64_t gpu_v_length, 
    int64_t gpu_v_offset, 
    int64_t gpu_v_stride, 
    int64_t map_size = 256)
{
    int blockSize = BLOCK_SIZE_CP;
    int numBlocks = batch_size * heads;
...
void gather_copy_with_offsets(
    ...
    int64_t batch_size, int64_t heads, int64_t cpu_v_length, int64_t gpu_v_length, int64_t gpu_v_offset, int64_t gpu_v_stride, int64_t map_size = 256) // input, torch stream
{
    int blockSize = BLOCK_SIZE_CP;
