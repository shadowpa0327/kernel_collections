...
from ops import qAB_rope_v1, qAB_rope_v2, qAB_rope_v3, qAB_rope_v4
import triton
...
def test_correctness(bsz, num_heads, num_kv_heads, rank, head_dim, q_len, kv_len):
    ...
    print(out_triton, out_ref)
    print(torch.max(torch.abs(out_triton-out_ref)))
...
def run_qk_qab_benchmark(
    ...
    configs.append(
        triton.testing.Benchmark(
            ...
            line_vals=['qk', 'qab_v1', 'qab_v2', 'qab_v3'],
            line_names=['qK (Standard)', 'qAB_v1 (Triton)', 'qAB_v2 (Triton)', 'qAB_v3 (Triton)'],
