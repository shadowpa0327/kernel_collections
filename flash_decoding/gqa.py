...
def decode_attention_fwd(
    ...
    k_buffer : torch.Tensor
        Key cache buffer of shape [batch, kv_len, num_kv_heads, head_dim]
        Contains the keys for all tokens in the context
    v_buffer : torch.Tensor
        Value cache buffer of shape [batch, kv_len, num_kv_heads, head_dim]
        Contains the values for all tokens in the context
    o : torch.Tensor
    ...
    # Stage 2: Combine partial outputs from all KV splits
